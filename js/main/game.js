...
export const game = {
    ...
    /*Множитель для расчета локальной переменной "maxDeltaTime" в методе "gameLoop()".*/
    ...
    gameLoop: function (
        ...
        переданная в нее callback-функция будет вызываться равное частоте обновления монитора раз в секунду, при этом 
        ...
        while (
            ...
            /*Поскольку были рассчитаны данные для одного кадра, то вычитаем из времени, накопленного для расчета данных 
            для кадров, время, необходимое на расчет данных для одного кадра.*/
            this.accumulatedTimeForCalculatingFrameData -= this.fixedTimeStep;
