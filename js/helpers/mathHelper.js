...
export const mathHelper = {
    ...
    2. Проверяем не находится ли точка снаружи "ограничивающей коробки" многоугольника.
    3. Находим точку пересечения луча и максимальной X-координатой среди вершин многоугольника, так как пускаем луч 
    вправо.
    4. Находим точки с целочисленными координатами на отрезке луча.
    ...
    друга на 1.
    8. Проверяем не получается ли так, что все точки в упомянутом массиве совпадают с вершинами многоугольника. Если это 
